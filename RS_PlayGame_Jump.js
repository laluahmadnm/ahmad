...
PlayGameState.prototype.Update = function()
{
    ...
    if(this.posShortlog1 < -190)
    {
        this.posShortlog1 = 1000;
        
        var y_position_values_ud = [230, 200, 170];
    ...
    else if(this.jumpbutton1 == false)
    {
        this.jumpPower = -15;
    }
    else if(this.jumpbutton2 == false)
    {
        this.jumpPower = -15;
    }
    else if(this.jumpbutton3 == false)
    {
        this.jumpPower = -15;
    }
};
